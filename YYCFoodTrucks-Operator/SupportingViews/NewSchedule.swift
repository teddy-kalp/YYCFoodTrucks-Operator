...
struct NewSchedule: View {
    ...
    func addSchedule(){
        if (self.address == ""){
            ...
            var scheduleId = randomString(length: 20)
            ...
            ScheduleRepo.addSchedule(locationId: locationId, truckId: truck.id!, openDate: start, closeDate: end, schedule_id: scheduleId)
